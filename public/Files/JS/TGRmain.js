(function($) {
    ...
    //     var header = $('.header'),
    //         scrollPosition = 0,
    //         headerTopHeight = $('.header__top').outerHeight(true),
    //         i=0,
    //         checkpoint = 400;
    ...
    //                     header.removeClass('pin').addClass('unpin navigation--sticky');
    ...
    function inputNumberChange() {
        var number = $('.ps-numbernoneed');
        var max = $("#selqty").data('max');
    ...
    $(window).on('resize', function() {
        ...
        if (win.width() >= 1217) {
            $(".main-menu").prependTo(".menu-position");
